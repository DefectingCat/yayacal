...
- 七夕问候遮罩：七夕当天（农历七月初七，经 tyme4kt 判定并排除闰七月）每次冷启动后全屏展示节日壁纸与「七夕快乐！」艺术字（站酷快乐体子集，SIL OFL 授权），点击任意处或按返回键以 300ms 淡出退出，非七夕日期完全不出现。
- 生日问候遮罩：每年公历 9 月 4 日每次冷启动后全屏展示线条小狗钞票壁纸与「生日快乐！」艺术字（站酷快乐体子集，SIL OFL 授权），金色生日皇冠先自上方轻落、文字自下方浮起级联入场（graphicsLayer 驱动，不触发布局），点击任意处或按返回键以 300ms 淡出退出，非生日日期完全不出现。
